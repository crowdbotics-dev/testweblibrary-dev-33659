...
## Project Structure
    ...
    ├── testweblibrary_dev_33659  # Django project configurations
...
1. Clone this repo and `cd testweblibrary_dev_33659`
...
2. Clone this repo and `cd testweblibrary_dev_33659`
